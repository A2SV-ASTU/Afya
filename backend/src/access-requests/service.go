...
type Service interface {
	...
	CreateRequest(ctx context.Context, clinicID, doctorID uuid.UUID, req CreateAccessRequestRequest) (*AccessRequest, error)
...
func (s *service) CreateRequest(ctx context.Context, clinicID, doctorID uuid.UUID, req CreateAccessRequestRequest) (*AccessRequest, error) {
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Please log in to your patient portal to review and either approve or deny this request.</p>
            <div class="alert">
                <strong>Important:</strong> This request will automatically expire in 5 minutes.
            </div>
        </div>
        <div class="footer">
...
</html>`, patient.FirstName, clinicName, clinicName, req.Reason)
