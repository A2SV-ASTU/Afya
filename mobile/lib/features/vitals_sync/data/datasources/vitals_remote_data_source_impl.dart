...
class VitalsRemoteDataSourceImpl implements VitalsRemoteDataSource {
  ...
  Future<VitalsSyncBatchResultEntity> syncVitals(
    ...
    final response = await apiClient.dio.post(
      ...
      data: {
        'readings': vitals.map((e) => e.toJson()).toList(),
      },
    );
  ...
  @override
  Future<List<VitalSignModel>> getDoctorVitals() async {
  ...
  Future<List<VitalSignModel>> getHistory() async {
    ...
    final vitalSigns =
        data['vital_signs'] as List<dynamic>? ?? [];
