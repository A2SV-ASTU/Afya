...
export function Modal({
  ...
  const modalContent = (
    <div
      id={id}
      className="fixed inset-0 z-100 overflow-y-auto bg-slate-950/60 backdrop-blur-sm flex items-center justify-center p-4 sm:p-6 animate-in fade-in duration-200"
    >
      <div
        ref={modalRef}
        className={cn(
